...
df = pd.read_csv("mutations_a-b.csv")
#Put Sample1, Sample2, Sample3, Sample4, ...
samples = [824606, 516771, "REFERE", "mv58", 824607, 824715, 593553, 593478, 824628, 824581, 824725, 940953, 824625, 824736, 824661, 824729, 677684, 883345, 583454, 940937, 824560, 824570, 593554, 593557, 475585, 937196, 940900, 940924, 824571, 940900]
#Put mvx, mvy, ...
name = []
for x in range(135,150):
    name.append("mv"+str(x+1))
